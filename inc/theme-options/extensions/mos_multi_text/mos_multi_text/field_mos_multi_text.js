...
(function( $ ) {
    ...
    redux.field_objects.mos_multi_text = redux.field_objects.mos_multi_text || {};

    redux.field_objects.mos_multi_text.init = function( selector ) {

        if ( !selector ) {
            selector = $( document ).find( '.redux-container-mos_multi_text:visible' );
        }
